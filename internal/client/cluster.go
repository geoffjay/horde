...
// plus every worker registered with this coordinator.
...
// worker nodes with their last-seen time, agent ids, and staleness.
...
// contexts from all workers. Served by the coordinator only. An optional issue
