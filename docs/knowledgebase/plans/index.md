...
* [TUI for projects, teams, and execution context](tui-projects.md) - mockup concepts and an implementation sketch for a breadcrumb-navigated TUI over projects, teams, execution context, invoke, and cluster.
